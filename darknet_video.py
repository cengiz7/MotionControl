...
def YOLO():
    ...
    user = face.select_user(facePath, cap)
    ...
    # TODO: user olusturma kodunu ve capture kodlarini yukaridan buraya tasi
    ...
    while True:
        ...
        sign_detector.update_min_activator(round(fps_val/4))
        # hand sign detection
